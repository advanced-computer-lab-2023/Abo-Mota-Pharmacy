    ...
    <div className='otp-portal-container'>
      <div className='otp-portal'>
        <div className='otp-button-container'>
          ...
          <span className='otp-close-button-span' onClick={closeForm}>
        ...
        <p className='otp-paragraph'>
          ...
          {showButton ? (
            <span
              className='otp-resend-span otp-resend-clickable'
            ...
            <span className='otp-resend-span'> wait {seconds} seconds</span>
          )}
        </p>
      </div>
