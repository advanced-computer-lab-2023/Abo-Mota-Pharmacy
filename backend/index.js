...
io.on("connection", (socket) => {
	...
	socket.on("send_message", async (data) => {
		...
		io.to(senderSocketId).emit("receive_message", { message, senderData, recipientData});
		...
		if (isRelayToClinic)
			...
			if (recipientSocketId) {
				socket.to(recipientSocketId).emit("receive_message", { message, senderData, recipientData});
			}
		}
